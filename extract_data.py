...
for i in range(len(vehicle)):
	...
	for j, t in enumerate(vehicle[i].t):
		if j % freq == 0 and j < size:
			...
			if g[i].ff[j] != -1 and g[i].ff[j] < len(vehicle):
			...
			if g[i].f[j] != -1 and g[i].f[j] < len(vehicle):
			...
			if g[i].fr[j] != -1 and g[i].fr[j] < len(vehicle):
			...
			if g[i].fl[j] != -1 and g[i].fl[j] < len(vehicle):
			...
			if g[i].l[j] != -1 and g[i].l[j] < len(vehicle):
			...
			if g[i].r[j] != -1 and g[i].r[j] < len(vehicle):
			...
			if g[i].b[j] != -1 and g[i].b[j] < len(vehicle):
			...
			if g[i].br[j] != -1 and g[i].br[j] < len(vehicle):
			...
			if g[i].bl[j] != -1 and g[i].bl[j] < len(vehicle):
...
np.save('inputs.npy', dataset)
np.save('labels.npy', targets)
#np.save('timesteps.npy', t_data)